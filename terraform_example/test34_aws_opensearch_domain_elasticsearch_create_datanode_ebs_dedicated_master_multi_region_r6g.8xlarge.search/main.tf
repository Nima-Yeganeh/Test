...
resource "aws_opensearch_domain" "data_nodesaws1" {
  domain_name           = "my-opensearch-xxxdomainaws1"
...
resource "aws_opensearch_domain" "data_nodesaws2" {
  domain_name           = "my-opensearch-xxxdomainaws2"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws3" {
  domain_name           = "my-opensearch-xxxdomainaws3"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws4" {
  domain_name           = "my-opensearch-xxxdomainaws4"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws5" {
  domain_name           = "my-opensearch-xxxdomainaws5"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws6" {
  domain_name           = "my-opensearch-xxxdomainaws6"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws7" {
  domain_name           = "my-opensearch-xxxdomainaws7"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws8" {
  domain_name           = "my-opensearch-xxxdomainaws8"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws9" {
  domain_name           = "my-opensearch-xxxdomainaws9"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws10" {
  domain_name           = "my-opensearch-xxxdomainaws10"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws11" {
  domain_name           = "my-opensearch-xxxdomainaws11"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws12" {
  domain_name           = "my-opensearch-xxxdomainaws12"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws13" {
  domain_name           = "my-opensearch-xxxdomainaws13"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws14" {
  domain_name           = "my-opensearch-xxxdomainaws14"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws15" {
  domain_name           = "my-opensearch-xxxdomainaws15"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws16" {
  domain_name           = "my-opensearch-xxxdomainaws16"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
...
resource "aws_opensearch_domain" "data_nodesaws17" {
  domain_name           = "my-opensearch-xxxdomainaws17"
  engine_version = "Elasticsearch_7.10"
  cluster_config {
    instance_type       = "r6g.8xlarge.search"
    instance_count      = 78
