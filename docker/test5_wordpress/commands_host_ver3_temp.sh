...
docker exec -it $targethost bash -c "wp user update $admin_user --display_name='Nimax Yeganeh' --allow-root"
docker exec -it $targethost bash -c "wp user update $admin_user --nickname='Nimax Yeganeh' --allow-root"
docker exec -it $targethost bash -c "wp user update $admin_user --user_nicename='Nimax Yeganeh' --allow-root"
